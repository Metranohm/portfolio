...
function About() {
  return (
    ...
    <div classname={styles.container}>
      ...
      <br></br>
      My experience in Human Resources and music instruction make communication & leadership come naturally to me and I thrive in a group work environment.  I look forward to combining these talents with my new skills as a software engineer to design creative solutions to real-world problems.
      </p>
    </div>
    </>
  );
